...
data = pd.read_csv("obesity_db.csv")
data.head()
# %%
...
max_information_gain_split(data['Gender'], data['obese'],)  
...
# %%
mask = data.drop('obese', axis= 1).apply(max_information_gain_split, y = data['obese'])
